...
<div class="<?php echo $classes; ?>" <?php echo $el_id;?>>
    <div class="lrooms-item fl-wrap">
        ...
        <div class="lrooms-details">
            ...
            ?>
            <div class="lroom-dbtn ml-5"><button class="room-modal-open" data-roomid="<?php echo esc_attr( get_the_ID() );?>"><?php esc_html_e( 'Details' ,'townhub-add-ons'); ?><i class="fal fa-arrow-right"></i></button></div>
        </div>
    </div>
</div>