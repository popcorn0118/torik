...
class NextendSocialLoginPRO {
    ...
    public static $nslMinVersion = '3.0.27';
    ...
    public static function plugins_loaded() {
        if (!defined('NSL_PATH')) {
            ...
            if ($lastVersion != self::$version && version_compare(NextendSocialLogin::$version, self::$nslMinVersion, '>=')) {
                 ...
                 */
                if (!empty($lastVersion) && version_compare($lastVersion, '3.0.25', '<=') && NextendSocialLogin::$settings->get('registration_notification_notify') == '0') {
    ...
    public static function bp_register_form() {
        ...
        if (!empty($template) && file_exists($template)) {
            ...
            $buttons = NextendSocialLogin::renderButtonsWithContainer(NextendSocialLogin::$settings->get('buddypress_register_button_style'), false, false, false, NextendSocialLogin::$settings->get('buddypress_register_button_align'), 'register');
