	...
	protected function _register_controls() {
		...
		$this->add_control(
		    ...
		    [
			    ...
			    'raw' => __( 'Note: Please insert two widgets on the same section then place your widgets id here (without #) and also on another Switcher. 
								This will marge your both widgets in the same place and visible them to your Switcher target.', 'bdthemes-element-pack' ),
