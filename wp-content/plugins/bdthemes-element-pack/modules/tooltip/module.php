...
class Module extends Element_Pack_Module_Base {
	...
	public function register_controls_widget_tooltip($widget, $widget_id, $args) {
		...
		$widget->add_control(
			'element_pack_widget_tooltip_append_body',
			[
				'label'       => esc_html__( 'Append to Body', 'bdthemes-element-pack' ),
				'description' => esc_html__( 'For tiny place usages you need to set yes for show tooltip properly.', 'bdthemes-element-pack' ),
				'type'        => Controls_Manager::SWITCHER,
				'condition'   => [
					'element_pack_widget_tooltip' => 'yes',
				],
		...
		$widget->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tippy-popper .tippy-tooltip, {{WRAPPER}} .tippy-popper .tippy-tooltip .tippy-backdrop',
				'condition' => [
					'element_pack_widget_tooltip' => 'yes',
				],
			]
	...
	public function widget_tooltip_before_render($widget) {    		
		...
		if( $settings['element_pack_widget_tooltip'] == 'yes' ) {
			...
			if (!empty($settings['element_pack_widget_tooltip_append_body'])) {
				$widget->add_render_attribute( '_wrapper', 'data-tooltip-placement', 'body', true );
			}
