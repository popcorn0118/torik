...
class Ekit_facebook_settings {
	...
	public function get_fb_page_posts($limit = 5, $fields = []) {
		...
		try {
			...
			$fld     = 'id,message,attachments{description,title,type,url,media},from,comments{message,like_count,user_likes,permalink_url},likes{username,name},shares,permalink_url,full_picture,created_time';
